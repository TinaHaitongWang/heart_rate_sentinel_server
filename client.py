...
for patient in range(10):
    r = requests.get("http://127.0.0.1:5000/api/heart_rate/{0}"
                     .format(patient+1))
    print(r.text)

# get status of patient
for patient in range(10):
    r = requests.get("http://127.0.0.1:5000/api/status/{0}"
                     .format(patient+1))
    print(r.text)

# get average heart rate of patient
for patient in range(10):
    r = requests.get("http://127.0.0.1:5000/api/heart_rate/average/{0}"
                     .format(patient+1))
    print(r.text)
